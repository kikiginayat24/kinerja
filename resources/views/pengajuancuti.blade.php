                    ...
                    <div class="table-responsive">
                      <table class="table card-table table-vcenter text-nowrap datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                              <td>{{$x}}</td>
                              <td><span class="text-secondary">{{$cuti->id}}</span></td>
                              <td>{{$cuti->nama_lengkap}}</td>
                              @php
                                foreach ($getJenisCuti as $jenisCuti) {# code...
                                    if($cuti->kode == $jenisCuti->kode){
                                      $alasan = $jenisCuti->jenis;
                                    }
                                }
                              @endphp
                              <td>
                              ...
                              <td class="text-end">
                                  <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#approveIzin{{$cuti->id}}"><svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-search"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0" /><path d="M21 21l-6 -6" /></svg>Tinjau</button>
                              </td>
                            </tr>
                            <div class="modal modal-blur fade" id="approveIzin{{$cuti->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <form action="{{route('cuti.update', $cuti->id)}}" method="post">
                                        ...
                                        <div class="modal-body">
                                            <input type="hidden" name="id_user" id="id_user" value="{{$cuti->id_user}}">
                                            <p>ID Pengajuan : {{$cuti->id}}</p>
                                            <p>Nama Lengkap: {{$cuti->nama_lengkap}}</p>
                                            <p>Alasan: {{$alasan}}</p>
                                            <hr class="m-1">
                                            <div class="mb-3">
                                                <label class="form-label">Tanggal Awal</label>
                                                <div class="input-icon">
                                                    <input class="form-control " placeholder="Select a date" name="tgl_awal" id="tgl_awal" value="{{$cuti->tgl_awal}}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-icon">
                                                    <input class="form-control " placeholder="Select a date" name="tgl_akhir" id="tgl_akhir" value="{{$cuti->tgl_akhir}}">
                                                    <span class="input-icon-addon"><!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                                                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M4 7a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12z"></path><path d="M16 3v4"></path><path d="M8 3v4"></path><path d="M4 11h16"></path><path d="M11 15h1"></path><path d="M12 15v3"></path></svg>
                                                    </span>
                                                </div>
